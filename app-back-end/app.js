...
app.get('/projects/:projectId', (req, res) => {
    ...
    if(project == undefined) {
        res.status(404).json({code: 404, message: "Aucun projet n'a été trouvé avec cet id."});
    }
    res.json(project);
});
...
app.put('/projects/:projectId', (req, res) => {
    ...
    projectDao.updateProject(project) ? res.sendStatus(200) : res.status(400).json({code: 400, message: "Problème lors de la mise à jour du projet." })
});
